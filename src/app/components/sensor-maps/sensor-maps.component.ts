  ...
  getInfoWindowContents(eachData: any, cb) {
    this.dmService.latlngToAddress(eachData.latitude, eachData.longitude, (address) => {
      ...
      var contents = `
        ...
        <table>
          <tr>
            <th colspan="4">Last Measured Date</th>
            <td colspan="4">2019/01/21 15:23:00</td>
          </tr>
          <tr>
          <th colspan="8" style="border-left: solid #fff; border-right: solid #fff;"></th>
          </tr>
          <tr>
            <th colspan="8">Device Available</th>
          </tr>
          <tr>
            <th>PH</th>
            <th>Iron</th>
          ...
          <tr>
            <td class="center">${
              eachData.status.temp
                ? '<i class="fa fa-circle" style="color: #03daa4" aria-hidden="true"></i>'
                : '<i class="fa fa-circle" style="color: #8585858c" aria-hidden="true"></i>'
            }</td>
            <td class="center">${
              eachData.status.co
                ? '<i class="fa fa-circle" style="color: #03daa4" aria-hidden="true"></i>'
            ...
            <td class="center">${
              eachData.status.pm25
                ? '<i class="fa fa-circle" style="color: #03daa4" aria-hidden="true"></i>'
                : '<i class="fa fa-circle" style="color: #8585858c" aria-hidden="true"></i>'
            }</td>
            <td class="center">${
              eachData.status.pm10
                ? '<i class="fa fa-circle" style="color: #03daa4" aria-hidden="true"></i>'
                : '<i class="fa fa-circle" style="color: #8585858c" aria-hidden="true"></i>'
            }</td>
            <td class="center">${
